...
class ConfigurationPreUpgradeCheckStatusApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.update_pre_upgrade_check_status_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [],
                'endpoint_path': '/device/action/status/preupgrade/check',
                'operation_id': 'update_pre_upgrade_check_status',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
    ...
    def update_pre_upgrade_check_status(
        ...
        **kwargs
        ...
        """update_pre_upgrade_check_status  # noqa: E501

        Update pre upgrade check status  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_pre_upgrade_check_status(async_req=True)
        >>> result = thread.get()
        ...
        return self.update_pre_upgrade_check_status_endpoint.call_with_http_info(**kwargs)
