...
class ConfigurationQuickConnectApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.submit_day0_config_endpoint = _Endpoint(
            settings={
                'response_type': ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}],),
                'auth': [],
                'endpoint_path': '/template/config/quickConnect/submitDevices',
                'operation_id': 'submit_day0_config',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def submit_day0_config(
        ...
        **kwargs
        ...
        """submit_day0_config  # noqa: E501

        Creates and pushes bootstrap configurations onto day0 devices.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.submit_day0_config(async_req=True)
        >>> result = thread.get()
        ...
        return self.submit_day0_config_endpoint.call_with_http_info(**kwargs)
