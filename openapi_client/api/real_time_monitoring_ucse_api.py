...
class RealTimeMonitoringUcseApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_ucse_stats_endpoint = _Endpoint(
            settings={
                'response_type': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),
                'auth': [],
                'endpoint_path': '/device/ucse/stats',
                'operation_id': 'create_ucse_stats',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def create_ucse_stats(
        ...
        **kwargs
        ...
        """create_ucse_stats  # noqa: E501

        Get  UCSE stats entry from device  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_ucse_stats(device_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['device_id'] = \
            device_id
        return self.create_ucse_stats_endpoint.call_with_http_info(**kwargs)
